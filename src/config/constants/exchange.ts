...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD,maticTestnetTokens } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.MATIC_TESTNET]: '0x0C917a6cbe7A7c976493f57BE6A979e14613db53',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MATIC_TESTNET]: [maticTestnetTokens.wbnb],
}
