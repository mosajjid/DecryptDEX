...
export const FACTORY_ADDRESS_MAP: Record<number, string> = {
  ...
  [ChainId.MATIC_TESTNET]: '0xbd1A0c297348Db5E0c442e09681a4F5A75437Cfa',
}
...
export const INIT_CODE_HASH_MAP: Record<number, string> = {
  ...
  [ChainId.MATIC_TESTNET]: '0xa5934690703a592a07e841ca29d5e5c79b5e22ed4749057bb216dc31100be1c0',
}
...
export const WNATIVE: Record<number, Token> = {
  ...
  [ChainId.MATIC_TESTNET]: WBNB[ChainId.MATIC_TESTNET],
}
...
> = {
  ...
  [ChainId.MATIC_TESTNET]: {
    name: 'MATIC Mumbai Chain Native Token',
    symbol: 'tMATIC',
    decimals: 18,
  },
}
